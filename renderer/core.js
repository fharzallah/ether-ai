...
sb_chats:'المحادثات',sb_projects:'المشاريع',sb_content:'المكتبات',sb_trash:'سلة المحذوفات',sb_search:'بحث...',sb_no_chats:'لا محادثات',sb_no_projects:'لا مشاريع',sb_no_content:'المكتبة فارغة',sb_trash_empty:'السلة فارغة',sb_new_project:'+ مشروع جديد',
...
sb_chats:'对话',sb_projects:'项目',sb_content:'库',sb_trash:'回收站',sb_search:'搜索...',sb_no_chats:'没有对话',sb_no_projects:'没有项目',sb_no_content:'库为空',sb_trash_empty:'回收站为空',sb_new_project:'+ 新项目',
...
sb_chats:'チャット',sb_projects:'プロジェクト',sb_content:'ライブラリ',sb_trash:'ゴミ箱',sb_search:'検索...',sb_no_chats:'チャットなし',sb_no_projects:'プロジェクトなし',sb_no_content:'ライブラリは空です',sb_trash_empty:'ゴミ箱は空です',sb_new_project:'+ 新規プロジェクト',
...
sb_chats:'대화',sb_projects:'프로젝트',sb_content:'라이브러리',sb_trash:'휴지통',sb_search:'검색...',sb_no_chats:'대화 없음',sb_no_projects:'프로젝트 없음',sb_no_content:'라이브러리가 비어 있습니다',sb_trash_empty:'휴지통 비어있음',sb_new_project:'+ 새 프로젝트',
...
sb_chats:'Sohbetler',sb_projects:'Projeler',sb_content:'Kütüphaneler',sb_trash:'Cop kutusu',sb_search:'Ara...',sb_no_chats:'Sohbet yok',sb_no_projects:'Proje yok',sb_no_content:'Kütüphane boş',sb_trash_empty:'Cop kutusu bos',sb_new_project:'+ Yeni proje',
...
sb_chats:'Чаты',sb_projects:'Проекты',sb_content:'Библиотеки',sb_trash:'Корзина',sb_search:'Поиск...',sb_no_chats:'Нет чатов',sb_no_projects:'Нет проектов',sb_no_content:'Библиотека пуста',sb_trash_empty:'Корзина пуста',sb_new_project:'+ Новый проект',
