...
sb_chats:'Discussions',sb_projects:'Projets',sb_content:'Bibliothèques',sb_trash:'Corbeille',sb_search:'Rechercher...',sb_no_chats:'Aucune discussion',sb_no_projects:'Aucun projet',sb_trash_empty:'Corbeille vide',sb_new_project:'+ Nouveau projet',
...
sb_chats:'Chats',sb_projects:'Projects',sb_content:'Libraries',sb_trash:'Trash',sb_search:'Search...',sb_no_chats:'No chats',sb_no_projects:'No projects',sb_trash_empty:'Trash is empty',sb_new_project:'+ New project',
...
sb_chats:'Conversaciones',sb_projects:'Proyectos',sb_content:'Bibliotecas',sb_trash:'Papelera',sb_search:'Buscar...',sb_no_chats:'Sin conversaciones',sb_no_projects:'Sin proyectos',sb_trash_empty:'Papelera vacia',sb_new_project:'+ Nuevo proyecto',
...
sb_chats:'المحادثات',sb_projects:'المشاريع',sb_content:'المكتبات',sb_trash:'سلة المحذوفات',sb_search:'بحث...',sb_no_chats:'لا محادثات',sb_no_projects:'لا مشاريع',sb_trash_empty:'السلة فارغة',sb_new_project:'+ مشروع جديد',
...
sb_chats:'Chats',sb_projects:'Projekte',sb_content:'Bibliotheken',sb_trash:'Papierkorb',sb_search:'Suchen...',sb_no_chats:'Keine Chats',sb_no_projects:'Keine Projekte',sb_trash_empty:'Papierkorb leer',sb_new_project:'+ Neues Projekt',
...
sb_chats:'Conversazioni',sb_projects:'Progetti',sb_content:'Biblioteche',sb_trash:'Cestino',sb_search:'Cerca...',sb_no_chats:'Nessuna conversazione',sb_no_projects:'Nessun progetto',sb_trash_empty:'Cestino vuoto',sb_new_project:'+ Nuovo progetto',
...
sb_chats:'Conversas',sb_projects:'Projetos',sb_content:'Bibliotecas',sb_trash:'Lixeira',sb_search:'Pesquisar...',sb_no_chats:'Sem conversas',sb_no_projects:'Sem projetos',sb_trash_empty:'Lixeira vazia',sb_new_project:'+ Novo projeto',
...
sb_chats:'对话',sb_projects:'项目',sb_content:'库',sb_trash:'回收站',sb_search:'搜索...',sb_no_chats:'没有对话',sb_no_projects:'没有项目',sb_trash_empty:'回收站为空',sb_new_project:'+ 新项目',
...
sb_chats:'チャット',sb_projects:'プロジェクト',sb_content:'ライブラリ',sb_trash:'ゴミ箱',sb_search:'検索...',sb_no_chats:'チャットなし',sb_no_projects:'プロジェクトなし',sb_trash_empty:'ゴミ箱は空です',sb_new_project:'+ 新規プロジェクト',
...
sb_chats:'대화',sb_projects:'프로젝트',sb_content:'라이브러리',sb_trash:'휴지통',sb_search:'검색...',sb_no_chats:'대화 없음',sb_no_projects:'프로젝트 없음',sb_trash_empty:'휴지통 비어있음',sb_new_project:'+ 새 프로젝트',
...
sb_chats:'Sohbetler',sb_projects:'Projeler',sb_content:'Kütüphaneler',sb_trash:'Cop kutusu',sb_search:'Ara...',sb_no_chats:'Sohbet yok',sb_no_projects:'Proje yok',sb_trash_empty:'Cop kutusu bos',sb_new_project:'+ Yeni proje',
...
sb_chats:'Чаты',sb_projects:'Проекты',sb_content:'Библиотеки',sb_trash:'Корзина',sb_search:'Поиск...',sb_no_chats:'Нет чатов',sb_no_projects:'Нет проектов',sb_trash_empty:'Корзина пуста',sb_new_project:'+ Новый проект',
...
// Routing intelligent déplacé dans engine.js
